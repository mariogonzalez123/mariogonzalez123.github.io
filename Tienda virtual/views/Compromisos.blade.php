...
<form action="index.php" method="POST">
        ...
        <br><br><br>
        <!-- CONTAINER DONDE SE MUESTRAN LOS COMPROMISOS DE LA TIENDA -->
        <div class="container">
            <div class="card">    
                <div class="card-header">
                    <h3 class="header-carrito">Compromisos</h3>
                </div>    
                <div class="card-body">
                    <table class="table table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>Devoluciones gratuita</th>
                                <td>Si algo no te gusta o no te convence no queremos que te lo quedes, devuélvelo, gratuitamente, siempre. Tu satisfacción es lo primero.</td>

                            </tr>
                            <tr>
                                <th>Envios gratuitos</th>
                                <td>Nos comprometemos a realizar cualquier pedido gratuitamente</td>
                            </tr>
                            <tr>
                                <th>Somos expertos</th>
                                <td>Siempre podrás contar con ayuda experta, en caso de que tengas cualquier duda.</td>
                            </tr>
                            <tr>
                                <th>El mejor precio</th>
                                <td> Sabemos que ahorrar en tus compras es muy importante y nos esforzamos, al máximo, por ofrecerte los mejores precios. </td>
                            </tr>
                            <tr>
                                <th>Garantía Pow, la mejor solución para ti en 24h</th>
                                <td> rabajamos por tu satisfacción, resolviendo cualquier incidencia sobre tu pedido en menos de 24h. Si un producto fallase, te daremos solución en 24h conforme a lo que prefieras: cambio por un artículo nuevo, abono del importe pagado. </td>
                            </tr>
