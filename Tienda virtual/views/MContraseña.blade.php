...
<!-- CONTENEDOR LOGIN -->
    <div class="contenedor_login">
        <div class="menu_login">
            ...
            <br>
             <div><input type="password" name="password" id="passw" placeholder="*Repetir Contra"  class="login_contra" ><input style="margin-left:5px;"type="checkbox" onclick="toggle('passw')"></div>
            
            <br>
          
            <br>
         
            <input type="submit" name="Enviar" value="Cambiar contraseña" class="login_enviar" >
            <br>
            </form>   
            <div>
            </div>            
