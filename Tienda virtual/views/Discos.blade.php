...
<form action="index.php" method="POST">
        ...
        <div class="header_superior">
            ...
            <div class="search">
                ...
                <button type="submit" name="Enviar" value="buscar"><img src="/public/assets/imgs/lupa.png" height="12" width="18">
                    ...
                    <div class="cesta">
                        <img src="/public/assets/imgs/carrito.png" height="30px" width="30px">
    ...
    <br><br><br>
    <!-- CONTAINER DONDE SE MUESTRAN TODOS LOS DISCOS DE LA TIENDA. -->
    <div class="container">
        <div class="card">    
            <div class="card-header">
                <h3 class="header-carrito">Discos</h3>
            </div>    
            <div class="card-body">
